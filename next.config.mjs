...
const nextConfig = {
  ...
  async redirects() {
    return [
      { source: "/shop", destination: "/book", permanent: true },
      { source: "/shop/:slug", destination: "/book", permanent: true },
      { source: "/work", destination: "/", permanent: true },
      { source: "/gallery", destination: "/", permanent: true },
      { source: "/gallery/:slug", destination: "/", permanent: true },
      { source: "/services/sealcoating", destination: "/services/nutrition", permanent: true },
      { source: "/services/crack-filling", destination: "/services/exercise", permanent: true },
      { source: "/services/line-painting", destination: "/services/faith", permanent: true },
      { source: "/services/pavement-maintenance", destination: "/about", permanent: true },
      { source: "/services/weddings", destination: "/services/faith", permanent: true },
      { source: "/services/events", destination: "/services/exercise", permanent: true },
      { source: "/services/commercial", destination: "/contact", permanent: true },
      { source: "/services/sporting-events", destination: "/services/exercise", permanent: true },
    ];
  },
  async headers() {
    return [
