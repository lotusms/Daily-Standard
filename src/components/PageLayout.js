    ...
    <main className="relative z-10 w-full min-w-0">
      ...
      >
        <div className="flex flex-col justify-center items-center md:flex-row md:justify-between gap-2">
            ...
            <h1 className="mt-3 font-serif text-4xl font-semibold tracking-[-0.03em] text-slate-800 sm:text-5xl lg:text-[3.25rem] lg:leading-[1.08]">
              {title}
            </h1>
          </div>
          <div>
        ...
        {subtitle ? (
          <p className="mt-4 max-w-full text-base leading-relaxed text-slate-600">
            {subtitle}
          </p>
        ) : null}
      </div>
