...
import { ExerciseWatermark } from "@/components/home/HomeValueBarWatermarks";
...
const EXERCISE_FACTS = [
  {
    title: "Better mood under load",
    body: "Hard training clears mental static. A few honest sessions a week lower baseline stress — so you're less reactive at home and sharper at work.",
  },
  {
    title: "Focus that carries over",
    body: "Progressive training teaches attention. You practice showing up when you don't feel like it — then that muscle shows up in meetings, parenting, and hard conversations.",
  },
  {
    title: "Strength you can use",
    body: "This isn't vanity pumping. Real capacity — lifting, carrying, climbing stairs without wind — means your body serves your life instead of limiting it.",
  },
  {
    title: "Sleep and recovery",
    body: "Smart training deepens sleep. Overtraining wrecks it. The standard is enough intensity to grow, enough recovery to stay human the next day.",
  },
  {
    title: "Confidence in your body",
    body: "When you know you can push, pull, and move with control, posture changes — and so does how you walk into a room.",
  },
  {
    title: "Resilience under pressure",
    body: "Deadlines, travel, kids, injury setbacks — life will interrupt. A simple training standard keeps you from disappearing the moment motivation goes quiet.",
  },
];
...
const HERO = "/images/services/exercise/hero.png";
const EQUIPMENT = "/images/services/exercise/equipment.png";
const LIFT = "/images/services/exercise/lift.png";

export default function ExerciseServicePage() {
  return (
    <main className="relative z-10 w-full">
      ...
      <section className="relative isolate min-h-[min(92svh,44rem)] overflow-hidden">
        <Image
          src={HERO}
          alt="A garage gym with a barbell on a rubber mat in warm evening light"
          fill
          priority
          sizes="100vw"
          quality={88}
        ...
        <div className="relative z-10 mx-auto flex min-h-[min(92svh,44rem)] max-w-7xl flex-col justify-end px-6 pb-14 pt-[calc(7rem+env(safe-area-inset-top,0px))] sm:px-10 sm:pb-16 lg:px-12 lg:pb-20">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-[#f7f6f3]/80 sm:text-lg">
            Train for life — strength you can use, energy you can trust, and a
            body that serves your calling.
          </p>
          ...
          <ScrollSlideIn direction="left">
            ...
            <div className="mt-6 space-y-5 text-base leading-8 text-slate-600">
              <p className="text-[#2e2e2e]">
                Consistency dies when your program doesn&apos;t respect your
                recovery, your job, or the fact that you&apos;re not 22 anymore.
              </p>
              <p>
                Exercise coaching here is practical: lift, move, recover. We
                build a training standard you can hit three or four days a week
                — in a gym, garage, or hotel room — and we track what matters:
                strength, energy, and showing up.
              </p>
            </div>
          </ScrollSlideIn>
          ...
          <ScrollSlideIn direction="right" delay={80}>
            <div className="relative">
              <div className="relative aspect-4/3 overflow-hidden rounded-sm shadow-[0_28px_70px_-36px_rgba(46,46,46,0.55)] ring-1 ring-[#bb7e3b]/25">
                <Image
                  src={EQUIPMENT}
                  alt="Dumbbells and training gear arranged on a wooden bench"
                  fill
              ...
              <ExerciseWatermark className="pointer-events-none absolute -right-4 -bottom-6 h-32 w-32 text-[#bb7e3b] opacity-[0.12] sm:h-40 sm:w-40" />
            </div>
          </ScrollSlideIn>
        </div>
      </section>

      {/* Why exercise matters — facts */}
        ...
        <div className="relative mx-auto max-w-7xl px-6 sm:px-10 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-serif text-3xl font-semibold tracking-[-0.02em] text-[#f7f6f3] sm:text-4xl">
              Training that shapes how you show up
            </h2>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-[#f7f6f3]/65 sm:text-base">
              Exercise isn&apos;t only about looking stronger — it trains mood,
              focus, confidence, and the discipline you need everywhere else.
            </p>
          </div>

          <ul className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 lg:gap-5">
            {EXERCISE_FACTS.map((item, i) => (
              <li key={item.title}>
        ...
        <div className="mx-auto grid max-w-7xl items-stretch gap-0 px-6 sm:px-10 lg:grid-cols-[1.1fr_0.9fr] lg:gap-0 lg:px-12">
          <ScrollSlideIn direction="left">
            <div className="flex h-full flex-col justify-center border border-[#bb7e3b]/20 bg-[#f7f6f3] px-8 py-12 sm:px-12 sm:py-14 lg:rounded-l-sm lg:border-r-0">
              ...
              <blockquote className="-mt-6 font-serif text-2xl leading-snug text-[#2e2e2e] sm:text-3xl">
                Discipline in the gym spills into discipline everywhere else.
                That&apos;s the point.
              </blockquote>
          ...
          <ScrollSlideIn direction="right" delay={80}>
            <div className="relative min-h-[22rem] overflow-hidden lg:rounded-r-sm">
              <Image
                src={LIFT}
                alt="An athlete gripping a barbell mid-lift in a dimly lit gym"
                fill
      ...
      >
        ...
        <div className="relative mx-auto max-w-7xl px-6 sm:px-10 lg:px-12">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 font-serif text-3xl font-semibold tracking-[-0.02em] text-[#2e2e2e] sm:text-4xl">
              From assessment to lasting strength
            </h2>
          </div>
